...
[code of conduct](https://github.com/AlejandroSuero/pop.nvim/blob/main/CODE_OF_CONDUCT.md#contributor-covenant-code-of-conduct)**.
...
1. **Configure the development**
   ...
   - **Clone your fork**: After the fork, make a clone of your repo `username/pop.nvim`
